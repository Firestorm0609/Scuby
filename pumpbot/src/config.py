...
PUMP_FRONTEND_API_BASE = os.getenv("PUMP_FRONTEND_API_BASE", "https://frontend-api-v3.pump.fun")
POLL_INTERVAL_SECONDS = int(os.getenv("POLL_INTERVAL_SECONDS", 20))
POLL_CONCURRENCY = int(os.getenv("POLL_CONCURRENCY", 3))
# how long after creation to keep polling a token (same idea as ACTIVE_TRACK_SECONDS)
POLL_TRACK_SECONDS = int(os.getenv("POLL_TRACK_SECONDS", 3600))

MAX_SANE_MCAP_SOL = float(os.getenv("MAX_SANE_MCAP_SOL", 2000))
