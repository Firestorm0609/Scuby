...
class Database:
    ...
    def increment_daily_ca_count(self, user_id: int) -> bool:
        ...
        try:
            ...
            logger.error(f"❌ Error incrementing daily CA count: {e}")
            return False
    ...
    def can_forward_ca(self, user_id: int) -> bool:
        ...
        try:
            ...
            logger.error(f"❌ Error checking CA forward limit: {e}")
            return False
    ...
    def ca_already_forwarded(self, user_id: int, ca_address: str, route_id: int = None, hours: int = 24) -> bool:
        ...
        try:
            ...
            logger.error(f"❌ Error checking CA dedup: {e}")
            return False
    ...
    def url_already_forwarded(self, user_id: int, url_hash: str, route_id: int = None, hours: int = 24) -> bool:
        ...
        try:
            ...
            logger.error(f"❌ Error checking URL dedup: {e}")
            return False
