...
class MultiUserCABot:
    ...
    async def pricing_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await self.payment_handler.show_pricing(update.message, context)
    ...
    async def message_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Add route flow
            ...
            try:
                ...
                # Test access AND verify send permission for target chats
                success, result = await self.session_manager.test_chat_access(user_id, target_chat_id, check_send=True)
