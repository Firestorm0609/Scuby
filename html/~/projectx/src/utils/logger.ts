...
export const logger = {
  ...
  error: (msg: string, ...args: unknown[]) => {
    console.error(
      `${colors.gray}[${timestamp()}]${colors.reset} ${colors.red}ERR${colors.reset}   ${msg}`,
      ...args
    );
  },
  ...
  token: (msg: string, ...args: unknown[]) => {
    console.log(
      `${colors.gray}[${timestamp()}]${colors.reset} ${colors.magenta}TOKEN${colors.reset} ${msg}`,
      ...args
    );
  },
  ...
  trade: (msg: string, ...args: unknown[]) => {
    console.log(
      `${colors.gray}[${timestamp()}]${colors.reset} ${colors.bold}${colors.green}TRADE${colors.reset} ${msg}`,
      ...args
    );
  },
  ...
  filter: (msg: string, ...args: unknown[]) => {
    console.log(
      `${colors.gray}[${timestamp()}]${colors.reset} ${colors.yellow}FILTER${colors.reset} ${msg}`,
      ...args
    );
  },
